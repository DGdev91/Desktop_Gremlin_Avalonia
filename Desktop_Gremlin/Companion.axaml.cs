...
namespace Desktop_Gremlin
{
    ...
    public partial class Companion : Window
    {
        ...
        private void FollowMainGremlin()
        {
            ...
            var compCenter = new Point(this.Position.X + halfW, this.Position.Y + halfH);

            double mainHalfW = MainGremlin.Width / 2.0;
            double mainHalfH = MainGremlin.Height / 2.0;
            var mainCenter = new Point(MainGremlin.Position.X + mainHalfW, MainGremlin.Position.Y + mainHalfH);
